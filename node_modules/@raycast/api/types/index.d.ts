...
declare interface ConvenienceActions {
    ...
    /**
     * Action that navigates to the the Intall MCP Server command with some or all of the fields prefilled.
     *
     * @example
     * ```typescript
     * import { ActionPanel, Detail, Action } from "@raycast/api";
     ...
     *   return (
     *     <Detail
     *       markdown="Test out MCP Server installation"
     *       actions={
     *         <ActionPanel>
     *           <Action.InstallMCPServer server={{ name: "Sequential Thinking", transport: "stdio", command: "npx", args: ["-y", "@modelcontextprotocol/server-sequential-thinking"] }} />
     *         </ActionPanel>
     *       }
     *     />
     *   );
 ...
 * @throws {@link Error} if the command does not exist or is not enabled.
 ...
 declare interface MCPServer {
     /**
      * The icon to display for the MCP server.
      */
     icon?: Icon;
     /**
 ...
 declare interface SSEMCPServer extends MCPServer {
     ...
     url: string;
     /**
      * The HTTP headers to use for network requests to the MCP server.
      */
